...
# # Matches lines like: "0: (activate-alarm-tamper car1)"
...
#         actions = []
#         # pyperplan writes the actual plan to its own .soln file by default
#         # AND sometimes prints to stdout — check both
...
#         # Fallback: pyperplan also writes a `<problemfile>.soln` file
#         if not actions:
...
#     """pyperplan writes <problem>.soln by default — read it directly."""
#     import os
